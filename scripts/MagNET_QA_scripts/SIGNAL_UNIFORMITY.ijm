...
SIGNAL_UNIFORMITY_TEST(HNC_SNR_TRA_1,Results_dir);
SIGNAL_UNIFORMITY_TEST(HNC_SNR_COR_1,Results_dir);
SIGNAL_UNIFORMITY_TEST(HNC_SNR_SAG_1,Results_dir);




// run SIGNAL UNIFORMITY TEST for 3 slice orientations BODY COIL:
SIGNAL_UNIFORMITY_TEST(BC_SNR_TRA_1,Results_dir);
SIGNAL_UNIFORMITY_TEST(BC_SNR_COR_1,Results_dir);
SIGNAL_UNIFORMITY_TEST(BC_SNR_SAG_1,Results_dir);
...
Plot.create("Horizontal profile","Voxel number along X axis","Voxel intensity",Horizontal_profile);
print("okay4");
...
Plot.create("Vertical profile", "Voxel number along Y axis", "Voxel intensity", Vertical_profile);
